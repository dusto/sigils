...
type HostInput struct {
	...
	// Profileids List of Profile Ids to associate with Host
...
type ClientInterface interface {
	...
	AttachProfile(ctx context.Context, hostUuid openapi_types.UUID, profileId int64, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) AttachProfile(ctx context.Context, hostUuid openapi_types.UUID, profileId int64, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAttachProfileRequest(c.Server, hostUuid, profileId)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewAttachProfileRequest(server string, hostUuid openapi_types.UUID, profileId int64) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	AttachProfileWithResponse(ctx context.Context, hostUuid openapi_types.UUID, profileId int64, reqEditors ...RequestEditorFn) (*AttachProfileResponse, error)
...
func (c *ClientWithResponses) AttachProfileWithResponse(ctx context.Context, hostUuid openapi_types.UUID, profileId int64, reqEditors ...RequestEditorFn) (*AttachProfileResponse, error) {
	rsp, err := c.AttachProfile(ctx, hostUuid, profileId, reqEditors...)
	if err != nil {
		return nil, err
	}
